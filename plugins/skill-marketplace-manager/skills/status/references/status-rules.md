...
Complete lookup procedures, ecosystem paths, card format templates, and status label definitions for the `/marketplace:status` command. This is the single source of truth for everything the status command needs.
...
ls -d /Users/mikey-east/Documents/claude-code-development/resources/utilities/claude-ecosystem/claude-plugins/*/  2>/dev/null | xargs -I{} basename {} | grep -v '^\.'
```
...
```bash
# Check existence
[ -f "/Users/mikey-east/Documents/claude-code-development/resources/utilities/mikey-skills-marketplace/skills/<name>/<name>.skill" ] && echo "present" || echo "absent"
...
```bash
# Check existence
[ -d "/Users/mikey-east/Documents/claude-code-development/resources/utilities/mikey-skills-marketplace/plugins/<name>" ] && echo "present" || echo "absent"
...
```
### <name> (skill)
- Local:       claude-skills/<name>/claude-code-skill/ [v<version>]
...
```
### <name> (plugin)
- Local:       claude-plugins/<name>/ [v<version>]
...
```bash
git -C /Users/mikey-east/Documents/claude-code-development/resources/utilities/mikey-skills-marketplace remote -v 2>/dev/null | grep -q origin && echo "remote_ok" || echo "no_remote"
```
...
git -C /Users/mikey-east/Documents/claude-code-development/resources/utilities/mikey-skills-marketplace status --porcelain 2>/dev/null | wc -l | tr -d ' '

# Count unpushed commits
git -C /Users/mikey-east/Documents/claude-code-development/resources/utilities/mikey-skills-marketplace log origin/main..HEAD --oneline 2>/dev/null | wc -l | tr -d ' '
```
