...
The scaffolded container is designed to pass `/marketplace:validate` immediately after creation — the templates are derived directly from what validate expects.
