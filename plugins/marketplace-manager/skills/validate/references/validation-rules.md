...
Complete check definitions for all validation categories. This is the single source of truth for every check the `/marketplace-manager:validate` command performs. All fix message templates and pass/fail criteria are defined here.
...
4. If neither exists, report: `Artifact '<name>' not found in skills/ or plugins/`
...
|-------|---------------|----------------------|
| Folder exists | `<skills-dir>/<name>/` is a directory | `Folder missing at skills/<name>/` |
| Source folder present | `<skills-dir>/<name>/claude-code-skill/` exists | `claude-code-skill/ missing — create skills/<name>/claude-code-skill/` |
| SKILL.md present | `<skills-dir>/<name>/claude-code-skill/SKILL.md` exists | `SKILL.md missing — create skills/<name>/claude-code-skill/SKILL.md` |
...
| Desktop folder present | `<skills-dir>/<name>/claude-desktop-skill/` exists | `claude-desktop-skill/ missing — create skills/<name>/claude-desktop-skill/` |
...
| Check | Pass Condition | Fail Message Template |
|-------|---------------|----------------------|
| Folder exists | `<plugins-dir>/<name>/` is a directory | `Folder missing at plugins/<name>/` |
...
- For skills: `skills/<name>/` (i.e., `<skills-dir>/<name>/`)
- For plugins: `plugins/<name>/` (i.e., `<plugins-dir>/<name>/`)
...
### Container
checkmark Folder exists at skills/recipe-optimiser/
...
### Container
checkmark Folder exists at skills/interview-research/
checkmark claude-code-skill/ present
checkmark SKILL.md present
checkmark No README.md inside claude-code-skill/
checkmark Folder name is kebab-case
...
### Documentation
cross No README.md at container level — create skills/interview-research/README.md
cross No CHANGELOG.md at container level — create skills/interview-research/CHANGELOG.md
...
| marketplace-manager | plugin | Fail | 3 |
```
