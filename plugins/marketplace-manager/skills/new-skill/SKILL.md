...
1. Create directories using `mkdir -p`:
   - `skills/NAME/claude-code-skill/`
   - `skills/NAME/claude-desktop-skill/`
2. Write files using templates from the reference file:
   - `skills/NAME/claude-code-skill/SKILL.md` — substitute NAME in both the `name:` field and the `# Heading` line; convert kebab-case NAME to Title Case for the heading
   - `skills/NAME/README.md` — substitute NAME in the title heading
   - `skills/NAME/CHANGELOG.md` — no substitution needed
